...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>Exploratory-Data-Analysis/README.md at master · semenoffalex/Exploratory-Data-Analysis</title>
    ...
    <link rel="web-socket" href="wss://live.github.com/_sockets/MTA1NzU1MTM6OGU4YzRiMDJhNTg1OTliYzg2ZWIyZmUzZWZiZmZkZWQ6ZTc3M2QwYzg5NjhkZGRiMTJjMzYzYzg3NGNkMmE3MGM3M2U3NjdhNzgzOTJjZTgyMzg1YTk3Zjc3NzBiMzc2NQ==--c65267b0372fb8ff9e1a41eb9128feb940ebeed1">
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="B6E1AAED:09F7:411EF2F:552A7E6D" name="octolytics-dimension-request_id" /><meta content="10575513" name="octolytics-actor-id" /><meta content="seonsu" name="octolytics-actor-login" /><meta content="8370db6795ef6da5a31d63fa3adab35ee33cb0d31a203cdac33f24cb676ca66e" name="octolytics-actor-hash" />
    ...
    <meta name="user-login" content="seonsu">
...
<meta content="7x764T7Rs+YrTIAsHm1hTuDr2tZurimWqcNhasPTwVrMpUDfWfWSuHH9lmDtHFnNRG4ALpXIRTYu3WAQmZLLrA==" name="csrf-token" />
...
<li>
  ...
  <li class="dropdown-header">
    ...
    <li>
      <a href="/semenoffalex/Exploratory-Data-Analysis/issues/new" data-ga-click="Header, create new issue, icon:issue"><span class="octicon octicon-issue-opened"></span> New issue</a>
    </li>
  ...
  <li class="header-nav-item">
    <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="mUgAE/6+gdaEI5RZuwnHUJaP+viu5KT35wP8uveTcIvBT6aY6sLY9TLEY+bc6S9YOLnIz5ZGc6dX2iERL/bx5g==" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="xxp4+B8RaDerSBvOaE6SEIyHJmajjKnmdnJXwAaf8xzK0LuOjKs/y3WSw/mBjTpH0lGDFYrKDZQ5osfSKHp0Tw==" /></div>    <input id="repository_id" name="repository_id" type="hidden" value="19666546" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/semenoffalex/Exploratory-Data-Analysis/unstar" class="js-toggler-form starred js-unstar-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="dykjbrxi2WqbQHaYnTGQlvf9nmvjHL+xfSJF5Vmz3eEOueRE/FuXkX+3bkdYeXi0RFKtn5paBcU9B0DiTnHlWw==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/semenoffalex/Exploratory-Data-Analysis/star" class="js-toggler-form unstarred js-star-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="gbmlGqFM7h/VwQ4O1P1m+ER+u1WBAA8O6XD0/79rrfdsHMra/4K7coaArT5/hQskWqmCrO+XBUP649GfpSIvdQ==" /></div>
      <button
        class="btn btn-sm btn-with-count js-toggler-target"
        ...
        <li>
          <form accept-charset="UTF-8" action="/semenoffalex/Exploratory-Data-Analysis/fork" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="iCB/t97yLwS8GJuX+bNfMph971+PZhDPBpp9jMrrb/9mroYHrAoyrMjrPksMzLSdAtoM7XqQW9j+uII7BwFb6A==" /></div>
            <button
                type="submit"
                class="btn btn-sm btn-with-count"
                data-ga-click="Repository, show fork modal, action:blob#show; text:Fork"
                title="Fork your own copy of semenoffalex/Exploratory-Data-Analysis to your account"
                aria-label="Fork your own copy of semenoffalex/Exploratory-Data-Analysis to your account">
              <span class="octicon octicon-repo-forked"></span>
              Fork
            </button>
            <a href="/semenoffalex/Exploratory-Data-Analysis/network" class="social-count">39</a>
</form>        </li>
...
<a href="/semenoffalex/Exploratory-Data-Analysis/blob/6d0d60bfd01f4a9f7be40c7c08a38cd5a758d7be/README.md" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:3a7639e0ed017043d2856b9e8b6e633d -->
...
<div class="select-menu js-menu-container js-select-menu left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/semenoffalex/Exploratory-Data-Analysis/blob/master/README.md"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
  ...
  <div class="commit file-history-tease">
    <div class="file-history-tease-header">
        ...
        <time datetime="2014-05-11T22:08:02Z" is="relative-time">May 12, 2014</time>
        <div class="commit-title">
            <a href="/semenoffalex/Exploratory-Data-Analysis/commit/6d0d60bfd01f4a9f7be40c7c08a38cd5a758d7be" class="message" data-pjax="true" title="Update README.md">Update README.md</a>
        </div>
    </div>
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/semenoffalex/Exploratory-Data-Analysis/raw/master/README.md" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/semenoffalex/Exploratory-Data-Analysis/blame/master/README.md" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/semenoffalex/Exploratory-Data-Analysis/commits/master/README.md" class="btn btn-sm " rel="nofollow">History</a>
      </div>

        <a class="octicon-btn tooltipped tooltipped-nw"
           href="github-windows://openRepo/https://github.com/semenoffalex/Exploratory-Data-Analysis?branch=master&amp;filepath=README.md"
           aria-label="Open this file in GitHub for Windows">
            <span class="octicon octicon-device-desktop"></span>
        </a>

            <form accept-charset="UTF-8" action="/semenoffalex/Exploratory-Data-Analysis/edit/master/README.md" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Bb/6mkamalMbfi+QXs6r1k1dq6T2rk1CAVM07O2Fs+sxNqy7tY0oG80teOSrW46h5HEYcFfp/yg9viv6k5y8PQ==" /></div>
          ...
          <form accept-charset="UTF-8" action="/semenoffalex/Exploratory-Data-Analysis/delete/master/README.md" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="j8VNqxuBmGfCcuxxRh4HStVdJGsySxccr6yXBRV2lFyFkU8yS5hTljaD2FH26TVo3mjGT6/GtmSUznmqLlxaBg==" /></div>
...
<a id="user-content-exploratory-data-analysis" class="anchor" href="#exploratory-data-analysis" aria-hidden="true"><span class="octicon octicon-link"></span></a>Exploratory Data Analysis</h1>

<p>This is my repository for the Coursera's course "Exploratory Data Analysis". Currently there are 8 files for the Course Project 1: 4 png pictures and 4 scripts to generate each.</p>

<p>To run this script you need to to the following:</p>

<ul class="task-list">
<li>Download the scripts (plot1.R, plot2.R, plot3.R, plot4.R) to some directory;</li>
<li>Download the data from here: <a href="https://d396qusza40orc.cloudfront.net/exdata%2Fdata%2Fhousehold_power_consumption.zip">https://d396qusza40orc.cloudfront.net/exdata%2Fdata%2Fhousehold_power_consumption.zip</a>;</li>
<li>Extract the data into ./Data subdirectory;</li>
<li>Run the scripts</li>
</ul>

<p>P.S. I removed the names of the X axis in plot 4 and fixed the names of the Y axis to make the graphs look more consistent, so my plots slightly differ from the ones in the description</p>
</article>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.05005s from github-fe132-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
